...
if st.button("📊 予測を実行"):
    ...
    ax.plot(result_df["予測日"], result_df["Bブロック予測"], marker='o', label="predict")
    ax.fill_between(result_df["予測日"], result_df["下限 (95%CI)"], result_df["上限 (95%CI)"], color='orange', alpha=0.2, label="95%CI")
